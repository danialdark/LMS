...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        @include('ostad.layouts.header')
        @include('ostad.layouts.sidebar')
        @if (session('success'))
        ...
        @include('ostad.layouts.rightsidebar')

        @include('ostad.layouts.footer')
    </div>
    <!-- ./wrapper -->

    <!-- REQUIRED SCRIPTS -->

    @include('ostad.layouts.scripts')
    @yield('script')
