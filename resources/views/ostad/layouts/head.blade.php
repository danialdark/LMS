<head>
    ...
    <link rel="stylesheet" href="{{ asset('panel/plugins/fullcalendar/fullcalendar.min.css') }}">
    <link rel="stylesheet" href="{{ asset('panel/plugins/fullcalendar/fullcalendar.print.css') }}" media="print">
