    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
                ...
                <a href="{{ route('master.class.index') }}" class="small-box-footer">اطلاعات بیشتر <i
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
                ...
                <a href="{{ route('master.class.create') }}" class="small-box-footer">ایجاد <i
                        class="fa fa-arrow-circle-left"></i></a>
            </div>
        </div>
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
                ...
                <a href="#" type="button" class="small-box-footer" data-toggle="modal" data-target="#uploadmodal">
                    آپلود فایل<i class="fa fa-arrow-circle-left"></i>
                </a>
            </div>
        </div>
    </div>
        ...
        <section class="col-lg-7 connectedSortable">
            ...
            <div class="card">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="mr-5">
                                                @if ($start_time < $nowtime && $nowtime < $end_time)
                                                    <a href="https://pafcoerp.com/VCUI/Operation/Default.pc"
                ...
                <div class="card-footer text-center" style="display: block;">
                    <a href="{{ route('master.class.index') }}" class="uppercase">نمایش همه کلاس ها</a>
                </div>
                <!-- /.card-footer -->
            </div>
            {{-- incoming class list --}}
                            ...
                            @if ($tasktime->greaterThanOrEqualTo($now))
                                <li>
                                    ...
                                    <div class="tools d-flex">
                                        ...
                                        <form action="{{ route('master.task.destroy', $task->id) }}" method="POST">
                                            @csrf
                                            @method("delete")
                ...
                <div class="card-footer clearfix">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('master.task.store') }}" method="Post">
                                        @csrf
                    ...
                    <div class="modal fade" id="uploadmodal" tabindex="-1" role="dialog" aria-labelledby="uploadmodal"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="uploadmodal">اپلود فایل</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <form action="{{ route('master.upload.store') }}" method="Post"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <label class="form-label" for="class">کلاس</label>
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="file_name">نام فایل</label>
                                            <input type="text" name="file_name" id="file_name" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label" for="name">فایل</label>
