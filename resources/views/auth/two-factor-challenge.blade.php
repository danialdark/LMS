    ...
    <x-jet-authentication-card>
        ...
        <div x-data="{ recovery: false }">
            <div class="mb-4 text-sm text-gray-600" x-show="! recovery">
                {{ __('لطفا وارد برنامه googleathentication شده و کد مربوطه را وارد کنید.') }}
            </div>

            <div class="mb-4 text-sm text-gray-600" x-show="recovery">
                {{ __('لطفا کلید اظطراری خود را برای تایید هویت وارد کنید') }}
            </div>
            ...
            <form method="POST" action="{{ route('two-factor.login') }}">
                ...
                <div class="mt-4" x-show="! recovery">
                    <x-jet-label for="code" value="{{ __('رمز دوم') }}" />
                ...
                <div class="mt-4" x-show="recovery">
                    <x-jet-label for="recovery_code" value="{{ __('کلید بازیابی') }}" />
