...
class MasterMessageController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("ostad.messages.index", compact("notifications", "unseen", "unsee"));
    }
    ...
    public function sent()
    {
        ...
        $unseen = count(Notif::where([["receiver_id", auth()->user()->id], ["status", 0]])->get());
        $unsee = Notif::where([["receiver_id", auth()->user()->id], ["status", 0]])->get();
        return view("ostad.messages.sent", compact("notifications", "unseen", "unsee"));
    }
    ...
    public function received()
    {
        ...
        $unseen = count(Notif::where([["receiver_id", auth()->user()->id], ["status", 0]])->get());
        $unsee = Notif::where([["receiver_id", auth()->user()->id], ["status", 0]])->get();
        return view("ostad.messages.received", compact("notifications", "unseen", "unsee"));
    }
    ...
    public function store(Request $request)
    {
        ...
        $notif->save();
        return redirect()->route("master.message.sent")->with("success", "پیام شما با موفقیت ارسال شد");
    }
    ...
    public function show($id)
    {
        ...
        $unseen = count(Notif::where([["receiver_id", auth()->user()->id], ["status", 0]])->get());
        $unsee = Notif::where([["receiver_id", auth()->user()->id], ["status", 0]])->get();
        return view("ostad.messages.show", compact("notif", "unseen", "unsee"));
    }
    ...
    public function destroy($id)
    {
        $notif = Notif::find($id);
        $notif->delete();
        return redirect()->route("master.message.index")->with("danger", "پیام شما با موفقیت حذف شد");
    }
}
